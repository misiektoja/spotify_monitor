...
- **BUGFIX:** **Network failures point at the right page** - A timed-out or unreachable Spotify request ow link to the new **Connection Problems** section, which explains the automatic retries and what to check if the failure continues.
