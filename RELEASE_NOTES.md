...
- **NEW:** Added optional **playlist and album artwork in ntfy alerts** with bounded HTTPS downloads and in-memory JPEG preparation. Failed image preparation or delivery falls back to the same alert as text
